          ...
          {displayProducts.map((product) => (
            ...
            >
              <article className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 h-full">
                ...
                {product.image ? (
                  <div className="aspect-4/3 bg-linear-to-br from-sage/10 to-gold/10 overflow-hidden">
                    <img
                      src={product.image}
                      alt={product.name}
                  ...
                  <div className="aspect-4/3 bg-linear-to-br from-sage/10 to-gold/10 flex items-center justify-center">
