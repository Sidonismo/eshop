    ...
    <div className="container mx-auto px-6 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          {product.image ? (
                <div className="aspect-3/4 bg-linear-to-br from-sage/10 to-gold/10 overflow-hidden">
              <img
                src={product.image}
                alt={product.name}
              ...
              />
                ...
                <div className="aspect-3/4 bg-linear-to-br from-sage/10 to-gold/10 flex items-center justify-center p-12">
