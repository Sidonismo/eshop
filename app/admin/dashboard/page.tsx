...
/**
 * Admin Dashboard - Správa ketubot
 *
 * Tento dashboard umožňuje:
 * - Zobrazit seznam všech ketubot
 * - Přidat novou ketubu
 * - Upravit existující ketubu
 * - Smazat ketubu
...
export default function AdminDashboardPage() {
  ...
  // Načti ketuboty při načtení stránky
  useEffect(() => {
    loadKetubas();
  }, []);
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-navy/5 to-gold/5">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        {/* Formulář pro přidání/úpravu ketuboty */}
        {showForm && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  className="px-6 py-3 bg-gold text-white font-bold rounded-lg hover:bg-gold/90 transition-colors"
                >
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="px-6 py-4 bg-navy text-white font-bold">
            Všechny ketuboty ({ketubas.length})
          </div>

          {ketubas.length === 0 ? (
            <div className="p-6 text-center text-sage">
              Zatím nejsou žádné ketuboty. Přidejte první!
            </div>
          ) : (
                ...
                <div key={ketuba.id} className="p-6 hover:bg-gray-50 transition-colors">
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex gap-4 text-sm">
                        <span className="text-gold font-bold">
                          {ketuba.price.toLocaleString('cs-CZ')} Kč
                        </span>
                        {ketuba.category && (
                          <span className="text-sage">
                            Kategorie: {ketuba.category}
                          </span>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex gap-2 ml-4 shrink-0">
                      ...
                      <button
                        onClick={() => handleDelete(ketuba.id)}
